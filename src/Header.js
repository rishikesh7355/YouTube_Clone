...
function Header() {
    return (
        <div className="header d-flex align-items-center justify-content-space-between">
            <div className="header-left-items d-flex align-items-center mxy-30"></div>
            <div className="menubar">
                ...
                <div className="header-middle-items d-flex align-items-center">
                    ...
                    <div className="search-icon pointer d-flex align-items-center">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="voiceSearch pointer  d-flex align-items-center">
                        <div className="voiceSearchShape">
                            <svg
                                xmlns="http://www.w3.org/2000/svg" 
                                viewBox="0 0 24 24"
                                focusable="false"
                                style={{ "width": "40px", "height": "25px", "color": "607d8b80" }}>
                ...
                <div className="header-rightbar d-flex align-items-center ">
                    <div className="create-options pointer">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            height="24"
                            style={{ "width": "25px", "height": "25px" }}
                    ...
                    <div className="bell-icon pointer ">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            enable-background="new 0 0 24 24"
                            height="24"
                    ...
                    <div className="profile">
                        <div className="profile-img pointer">
                            <img id="img" draggable="false" class="style-scope yt-img-shadow" alt="Avatar" height="32" width="32" src="https://yt3.ggpht.com/yti/ADpuP3Mek4lHsPUld_aKFcDoznLhw5OmpeY_SvRTGkST_A=s88-c-k-c0x00ffffff-no-rj" />
                        </div>
                    </div>
                </div>
            </div>
