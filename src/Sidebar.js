...
function Sidebar() {
    return (
        <div className="sidebar pointer">
            ...
            <div className="sidebar-items d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false" style={{ "width": "24", "height": "24" }}>
            ...
            <div className="sidebar-items d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" style={{ "width": "24", "height": "24" }} viewBox="0 0 24 24" width="24" focusable="false"><g><path d="M14.97 16.95 10 13.87V7h2v5.76l4.03 2.49-1.06 1.7zM22 12c0 5.51-4.49 10-10 10S2 17.51 2 12h1c0 4.96 4.04 9 9 9s9-4.04 9-9-4.04-9-9-9C8.81 3 5.92 4.64 4.28 7.38c-.11.18-.22.37-.31.56L3.94 8H8v1H1.96V3h1v4.74c.04-.09.07-.17.11-.25.11-.22.23-.42.35-.63C5.22 3.86 8.51 2 12 2c5.51 0 10 4.49 10 10z"></path></g></svg>
                <span className="sidebar-text">History</span>
            </div>
            <div className="sidebar-items d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" viewBox="0 0 24 24" focusable="false" style={{ "width": "24", "height": "24" }}><path d="m10 8 6 4-6 4V8zm11-5v18H3V3h18zm-1 1H4v16h16V4z"></path></svg>
                <span className="sidebar-text">Your Videos</span>
            </div>
            <div className="sidebar-items d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false" style={{ "width": "24", "height": "24" }}><path d="m22.01 4.91-.5-2.96L1.64 5.19 2 8v13h20V8H3.06l18.95-3.09zM5 9l1 3h3L8 9h2l1 3h3l-1-3h2l1 3h3l-1-3h3v11H3V9h2z"></path></svg>
                <span className="sidebar-text">Your Movies</span>
            </div>
            <div className="sidebar-items d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false" style={{ "width": "24", "height": "24" }}><path d="m18 9.28-6.35 6.35-6.37-6.35.72-.71 5.64 5.65 5.65-5.65z"></path></svg>
                <span className="sidebar-text">Show More</span>
            </div>
            <div className="sidebar-items d-flex align-items-center">
                <span>Subscriptions</span>
            </div>
            <div className="sidebar-items d-flex align-items-center">
                <img id="img" draggable="false" className="style-scope yt-img-shadow" height="24" width="24" alt="" src="https://yt3.ggpht.com/5Zr4bV9iJRa6zNS_-VSbZ7j5S8JhQc2Aez7b9y923AnYqJnltvI2iGdOFnWBcW-34ioPZlxzzLE=s88-c-k-c0x00ffffff-no-rj"></img>
                <span className="sidebar-text">India Today</span>
            </div>
            <div className="sidebar-items d-flex align-items-center">
            ...
            <div className="sidebar-items d-flex align-items-center">
                <img id="img" draggable="false" className="style-scope yt-img-shadow" height="24" width="24" alt="" src="https://yt3.ggpht.com/70r5TkYTLC0cpKLAiQEvcWLeIHB8yxoiog0nQIK9MmnZHqkICy0YA-jAaqfT2ChOBwehskjf5g=s88-c-k-c0x00ffffff-no-rj"></img>
                <span className="sidebar-text">TEDx Talks</span>
            </div>
            <div className="sidebar-items d-flex align-items-center">
                <span className="sidebar-text">Show 124 more</span>
            </div>
            <div className="sidebar-items d-flex align-items-center">
                <span >Explore</span>
            </div>
            ...
            <div className="sidebar-items d-flex align-items-center">
                ...
                <span className="sidebar-text">Shopping</span>
            </div>
            <div className="sidebar-items d-flex align-items-center">
            ...
            <div className="sidebar-items d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false" ><path d="M11 11v6H7v-6h4m1-1H6v8h6v-8zM3 3.03V21h14l4-4V3.03M20 4v11.99l-.01.01H16v3.99l-.01.01H4V4h16zm-2 4H6V6h12v2zm0 7h-5v-2h5v2zm0-3h-5v-2h5v2z"></path></svg>
            ...
            <div className="sidebar-items d-flex align-items-center">
                ...
                <span className="sidebar-text">Fashion & Beauty</span>
            </div>
            <div className="sidebar-items d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false" ><path d="M6 12c0-3.31 2.69-6 6-6s6 2.69 6 6c0 1.66-.67 3.16-1.77 4.25l-.71-.71C16.44 14.63 17 13.38 17 12c0-2.76-2.24-5-5-5s-5 2.24-5 5c0 1.38.56 2.63 1.47 3.54l-.71.71C6.67 15.16 6 13.66 6 12zm8 0c0-1.1-.9-2-2-2s-2 .9-2 2c0 .74.4 1.38 1 1.72V22h2v-8.28c.6-.34 1-.98 1-1.72zm-9.06 7.08.71-.71C4.01 16.74 3 14.49 3 12c0-4.96 4.04-9 9-9s9 4.04 9 9c0 2.49-1.01 4.74-2.65 6.37l.71.71C20.88 17.27 22 14.77 22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 2.77 1.12 5.27 2.94 7.08z"></path></svg>
                <span className="sidebar-text">Podcasts</span>
            </div>
            <div className="sidebar-items d-flex align-items-center">
                <span className="">More from YouTube</span>
            </div>
            <div className="sidebar-items d-flex align-items-center">
            ...
            <div className="sidebar-items d-flex align-items-center">
                ...
                <span className="sidebar-text">YouTube Kids</span>
            </div>
            <div className="sidebar-items d-flex align-items-center">
            ...
            <div className="sidebar-items d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false"><path d="m13.18 4 .24 1.2.16.8H19v7h-5.18l-.24-1.2-.16-.8H6V4h7.18M14 3H5v18h1v-9h6.6l.4 2h7V5h-5.6L14 3z"></path></svg>
            ...
            <div className="sidebar-items d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false"><path d="M13 14h-2v-2h2v2zm0-9h-2v6h2V5zm6-2H5v16.59l3.29-3.29.3-.3H19V3m1-1v15H9l-5 5V2h16z"></path></svg>
